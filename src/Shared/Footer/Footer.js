  ...
  return (
    <>
      <footer className="bg-[#2F2F30] pb-16">
        <div className="max-w-screen-xl px-7 pt-8 mx-auto sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <img alt="..." src={whiteLogo} className="mr-5 h-10 sm:h-6" />
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              <div>
                <p className="font-medium text-gray-400 uppercase">Company</p>
                <div className="h-[2px] w-10 mt-[-3px] bg-brand"></div>
              ...
              <div>
                <p className="font-medium text-gray-400 uppercase">Services</p>
                <div className="h-[2px] w-10 mt-[-3px] bg-brand"></div>
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-white">
                  <a className="hover:opacity-75 cursor-pointer" href>
                    1on1 Coaching
