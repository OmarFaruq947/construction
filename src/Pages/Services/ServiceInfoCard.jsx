    ...
    <>
      <div className="w-full">
        ...
        >
          ...
          />
          <div className="absolute gradient transition duration-300 bg-secondary opacity-70 group-hover:bg-secondary group-hover:opacity-90 w-full h-72 md:h-96 z-10"></div>
