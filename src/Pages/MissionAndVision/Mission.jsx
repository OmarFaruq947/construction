...
import image1 from '../../assets/Mission-Vission/Building permit-amico.png';
import image2 from '../../assets/Mission-Vission/Construction crane-pana.png';
import image3 from '../../assets/Mission-Vission/Construction-amico.png';
...
const Mission = () => {
  return (
    ...
    <div className="flex flex-col text-center w-full my-20">
      ...
      {/* Section 3 */}
      <section className="w-ful pt-7 pb-7 md:pt-20 md:pb-24">
